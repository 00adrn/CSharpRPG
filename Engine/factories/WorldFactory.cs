...
internal static class WorldFactory
{
    internal static World CreateWorld()
    {
        ...
        newWorld.AddLocation(0, -1, "Home", "Home, sweet home!", "csharptestgamehome.png");
        ...
        newWorld.AddLocation(0, 2, "Spider Forest", "Beware of the creepy crawlies.", "csharptestgamespiderforest.png");
